    ...
    >
      ...
      >
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="{{ Request::is('admin/articles*') ? 'active' : '' }} nav-link"  href="{{url('admin/articles')}}">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://iconcierge.vercel.app/">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class="{{ Request::is('admin/logout*') ? 'active' : '' }} nav-link" href="{{url('admin/logout')}}">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
